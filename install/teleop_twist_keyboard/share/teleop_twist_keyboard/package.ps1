...
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\share/teleop_twist_keyboard/hook/path.ps1"
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\share/teleop_twist_keyboard/hook/pythonpath.ps1"
colcon_package_source_powershell_script "$env:COLCON_CURRENT_PREFIX\share/teleop_twist_keyboard/hook/pythonscriptspath.ps1"
